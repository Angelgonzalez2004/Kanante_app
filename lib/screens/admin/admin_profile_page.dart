                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          ListTile(
                            ...
                            title: Text(_adminUser?.gender ?? 'No especificado'),
                            subtitle: const Text('Género'),
                          ),
                          const Divider(),
                          ListTile(
                            leading: const Icon(Icons.language),
                            title: Text(_adminUser?.preferredLanguage ?? 'Español'),
                            subtitle: const Text('Idioma Preferido'),
                          ),
                          const Divider(),
                          ListTile(
                            leading: const Icon(Icons.access_time),
                            title: Text(_adminUser?.timezone ?? 'No especificado'),
                            subtitle: const Text('Zona Horaria'),
                          ),
                        ],
                      ),
                    ),
